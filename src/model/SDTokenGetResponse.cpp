...
std::shared_ptr<SDTemplateGetTokensResponse_token_props> SDTokenGetResponse::getProps() const
{
    return m_Props;
}

void SDTokenGetResponse::setProps(const std::shared_ptr<SDTemplateGetTokensResponse_token_props>& value)
{
    m_Props = value;
    m_PropsIsSet = true;
}
