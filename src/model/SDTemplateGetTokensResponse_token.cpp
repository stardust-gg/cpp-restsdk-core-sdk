...
std::shared_ptr<SDPlayerGetInventoryResponse_props> SDTemplateGetTokensResponse_token::getProps() const
{
    return m_Props;
}

void SDTemplateGetTokensResponse_token::setProps(const std::shared_ptr<SDPlayerGetInventoryResponse_props>& value)
{
    m_Props = value;
    m_PropsIsSet = true;
}
