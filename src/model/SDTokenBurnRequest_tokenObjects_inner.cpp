...
SDTokenBurnRequest_tokenObjects_inner::SDTokenBurnRequest_tokenObjects_inner()
{
    m_TokenId = 0;
...
void SDTokenBurnRequest_tokenObjects_inner::validate()
{
    // TODO: implement validation
}

web::json::value SDTokenBurnRequest_tokenObjects_inner::toJson() const
{
...
bool SDTokenBurnRequest_tokenObjects_inner::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SDTokenBurnRequest_tokenObjects_inner::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SDTokenBurnRequest_tokenObjects_inner::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t SDTokenBurnRequest_tokenObjects_inner::getTokenId() const
{
    return m_TokenId;
}

void SDTokenBurnRequest_tokenObjects_inner::setTokenId(int32_t value)
{
    m_TokenId = value;
    m_TokenIdIsSet = true;
}

bool SDTokenBurnRequest_tokenObjects_inner::tokenIdIsSet() const
{
    return m_TokenIdIsSet;
}

void SDTokenBurnRequest_tokenObjects_inner::unsetTokenId()
{
    m_TokenIdIsSet = false;
}
utility::string_t SDTokenBurnRequest_tokenObjects_inner::getAmount() const
{
    return m_Amount;
}

void SDTokenBurnRequest_tokenObjects_inner::setAmount(const utility::string_t& value)
{
    m_Amount = value;
    m_AmountIsSet = true;
}

bool SDTokenBurnRequest_tokenObjects_inner::amountIsSet() const
{
    return m_AmountIsSet;
}

void SDTokenBurnRequest_tokenObjects_inner::unsetAmount()
{
    m_AmountIsSet = false;
}
}
